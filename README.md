...
2) Provision a new powerapps environment (take a note on language) and a power pages portal as explained here [dev.to/andrewelans/power-pages-spa-main-setup](https://dev.to/andrewelans/power-pages-spa-main-setup-2e0i)
5) ...
6) ...
7) ...
8) ...
